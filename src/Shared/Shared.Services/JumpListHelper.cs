...
public static class JumpListHelper
{
    ...
    {
        if (!NativeMethods.IsAppPackaged || !JumpList.IsSupported() || ControlInfoDataSourceBase.Current is null)
        {
            return;
        }
    ...
    {
        ControlInfoDataItem? item = ControlInfoDataSourceBase.Current?.Groups
